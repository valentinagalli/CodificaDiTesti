$("document").ready(function(){
    ...
    $(document).on("click", "#cambioAbbr", function(){   /*vedo abbr e sic*/
        if ($(this).data("click") == false) {
            $(this).data("click", true);
    ...
    $(document).on("click", "#tendaGloss", function(){   /*vedo il glossario*/
        if ($(this).data("click") == false) {
            $(this).data("click", true);
    ...
    $(document).on("click", "#tendaPers", function(){   /*vedo le persone nominate*/
        if ($(this).data("click") == false) {
            $(this).data("click", true);
