...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <p><xsl:text>passa il cursore sull'immagine per vedere la pericope corrispondente sul testo</xsl:text></p>
    ...
    <!--template abbr-expan e sic-corr come strong-->
    ...
    <xsl:template match="//tei:listPerson">
        ...
        <ul id="listaP">
            <li><b><xsl:value-of select="//tei:listPerson//tei:forename"/><xsl:text>:</xsl:text></b><xsl:text> né en </xsl:text><xsl:value-of select="//tei:listPerson//tei:birth//tei:date"/><xsl:text> en </xsl:text><xsl:value-of select="//tei:listPerson//tei:birth//tei:placeName"/><xsl:text> mort en </xsl:text><xsl:value-of select="//tei:listPerson//tei:death//tei:date"/><xsl:text> en </xsl:text><xsl:value-of select="//tei:listPerson//tei:death//tei:placeName"/></li>
        </ul>
    </xsl:template>
